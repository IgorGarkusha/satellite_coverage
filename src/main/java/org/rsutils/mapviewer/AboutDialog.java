...
public class AboutDialog extends JDialog
{
	public AboutDialog(JFrame owner, String title, String programName)
	{
		...
		JLabel jLabelCountry = new JLabel("Ukraine, Dnipro");
		jLabelCountry.setFont(new Font("Dialog", Font.BOLD, 12));
		Box hbox3 = Box.createHorizontalBox();
		hbox3.add(jLabelCountry);
		
		JLabel GPLV3Logo = new JLabel();
		GPLV3Logo.setIcon(new ImageIcon(getClass().getResource("/gplv3-127x51.png")));
		...
		String strJMapViewerInfo = "<html><center>Satellite Coverage based on &nbsp;"+
							...
							"Copyright (C) 2009-2022, Dirk Stöcker<br>"+
							...
							"Copyright (C) 2011-2017, Paul Hartmann<br>"+
							"Copyright (C) 2011-2016, Gleb Smirnoff<br>"+
							"Copyright (C) 2011-2022, Vincent Privat<br>"+
							"Copyright (C) 2011, Jason Huntley<br>"+
							"Copyright (C) 2012-2020, Simon Legner<br>"+
							...
							"Copyright (C) 2013, Galo Higueras<br>"+
							"Copyright (C) 2015-2019, Wiktor Niesiobędzki<br>"+
							"Copyright (C) 2017, Robert Scott</center></html>";
